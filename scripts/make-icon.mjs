// Renders the nodeterm app icon into build/icon.png (1024x1024) and the multi-resolution
// build/icon.ico used by Windows packaging (both gitignored — regenerated by `npm run
// make-icon`, which every dist script runs first). electron-builder derives the macOS
// .icns from the PNG and hands the ICO to NSIS/the exe resource editor as-is.
//
