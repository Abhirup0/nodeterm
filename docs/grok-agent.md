...
> Sibling documents: **`docs/gemini-agent.md`** is the same write-up for gemini (and carries the
> codex `--ask-for-approval` mapping), and the distilled rules both branches produced are the
